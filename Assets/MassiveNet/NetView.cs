...
namespace MassiveNet
{
    ...
    {
        /// <summary> 
        /// Server-assigned unique network identifier for this view.
        /// </summary>
        public int Id { get; internal set; }

        /// <summary>
        /// The group number that this NetView belongs to. 
        /// Only connections that are in this group will receive communications for this NetView.
        /// </summary>
        public int Group { get; internal set; }

        /// <summary> 
        /// Returns true if we are the server for this View.
        /// </summary>
        public bool AmServer { get { return (Server != null && Server.IsServer == false && Server.IsPeer == false); } }

        /// <summary>
        /// The server that is currently responsible for the view.
        /// This is initially the server that created the NetView, but can change in handoff.
        /// </summary>
        ...
        /// <summary>
        /// The connections that are authorized to send
        ///  RPCs to this NetView. The server uses this to determine which RPCs to allow from where.
        ///  </summary>
        internal readonly List<NetConnection> Controllers = new List<NetConnection>();

        /// <summary>
        /// This is the cache for object instances for RPC methods. 
        /// The key is the method name and the value is the Monobehavior instance.
        /// </summary>
        ...
        /// <summary>
        /// When a sync stream is received, 
        /// OnReadSync provides the NetStream which contains the sync data.
        /// </summary>
        ...
        /// <summary>
        /// OnWriteSync signals the sync event.
        /// Any RPC sent during sync will be batched and sent unreliably.
        /// </summary>
        ...
        /// <summary>
        /// Provides the NetStream that contains instantiation data (if any).
        /// </summary>
        ...
        /// <summary> 
        /// All data necessary to replicate this View's state for a proxy should be written to the stream. 
        /// </summary>
        ...
        /// <summary>
        /// All data necessary to replicate this View's state for the owner should be written to the stream.
        /// </summary>
        ...
        /// <summary>
        /// All data necessary to fully replicate this View's state should be written to the stream.
        /// </summary>
        ...
        /// <summary>
        /// All data necessary to replicate this View's state for a peer should be written to the stream.
        /// </summary>
        public event WritePeerData OnWritePeerData;

        /// <summary>
        /// Instead of creating a new NetStream for each sync event, it's cached here for performance.
        /// </summary>
        private NetStream syncStream;

        /// <summary>
        /// Instead of creating a new NetMessage for each sync event, it's cached here for performance.
        /// </summary>
        private NetMessage syncMessage;

        /// <summary>
        /// The scope config determines how this View is treated during scope calculations.
        /// </summary>
        ...
        /// <summary>
        /// Adds the provided connection to the controller list, allowing connection to send RPCs to this view.
        /// </summary>
        ...
        /// <summary>
        /// Returns true if the supplied connection is in the controllers list.
        /// </summary>
        ...
        /// <summary>
        /// Fires sync event to trigger sync messsage creation.
        /// </summary>
