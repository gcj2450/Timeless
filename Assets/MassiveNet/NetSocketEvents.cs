...
namespace MassiveNet
{
    ...
    public class NetSocketEvents
    {
        ...
        /// <summary>
        /// Fired after socket startup is complete.
        /// </summary>
        ...
        /// <summary>
        /// Fired when failed to connect to an endpoint; Provides the EndPoint.
        /// </summary>
        ...
        /// <summary>
        /// An incoming client connection has an endpoint and a stream of data.
        /// If true is returned, the client is approved and a connection is created. False
        /// will send a deny to the client.
        /// </summary>
        ...
        /// <summary>
        /// This is fired after approval but before a connection is created. 
        /// Using the supplied endpoint and stream, return true if the connection should be
        /// considered a peer, false if it is not a peer.
        /// </summary>
        ...
        /// <summary>
        /// Fired after an incoming connection is created. Provides the connection.
        /// </summary>
        ...
        /// <summary>
        /// Fired after a client connection is removed from the connections list. Provides
        /// the connection.
        /// </summary>
        ...
        /// <summary>
        /// Fired after an outgoing connection is created. Provides the connection.
        /// </summary>
        ...
        /// <summary>
        /// Fired after a server connection is removed from the connections list. Provides
        /// the connection.
        /// </summary>
        ...
        /// <summary>
        /// Triggered after ConnectToPeer, any data that is used by the receiving end to determine
        /// if we are a legit peer should be written to stream.
        /// </summary>
        ...
        /// <summary>
        /// Triggered after Connect, any data that is used by the receiving end to determine
        /// if we are a legit client should be written to stream.
        /// </summary>
        ...
        /// <summary>
        /// Fired after a peer connection is created. Provides the connection.
        /// This will fire after OnClientConnected or OnConnectedToServer.
        /// </summary>
        ...
        /// <summary>
        /// Fired after a peer connection is removed from the connections list. Provides
        /// the connection. This will fire after OnClientDisconnected or OnDisconnectedFromServer.
        /// </summary>
        ...
        /// <summary>
        /// Fired after a message is received. Provies the message and connection it came from.
        /// </summary>
