...
{
    /// <summary>
    /// Contains needed invoke data for a method marked with the NetRPC attribute.
    /// </summary>
    ...
    internal class RpcInfoCache
    {
        ...
        /// <summary>
        /// True if CacheRpcs has been run.
        /// </summary>
        ...
        /// <summary>
        /// Returns a List of parameter types for the provided RPC name.
        /// </summary>
        ...
        /// <summary>
        /// Iterates through the methods of the supplied type and adds any RPCs to the local RPC cache.
        /// </summary>
        ...
        /// <summary>
        /// Returns true if member method has NetRPC attribute.
        /// </summary>
