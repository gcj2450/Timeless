...
namespace MassiveNet
{
    internal class RequestDispatcher
    {
        ...
        /// <summary> 
        /// Request ID -> NetRequest instance lookup. When receiving a response to a NetRequest, it is directed using this.
        /// </summary>
        ...
        /// <summary>
        /// Generates the key to be used for the request dictionary lookup.
        /// </summary>
        ...
        /// <summary>
        /// Returns true if there is an active request matching the supplied ViewID and RequestID.
        /// </summary>
        ...
        /// <summary>
        /// Returns the type for the request. The type is needed for deserialization purposes.
        /// </summary>
        ...
        /// <summary>
        /// Removes the request from the active requests list.
        /// </summary>
