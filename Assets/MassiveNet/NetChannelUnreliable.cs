...
namespace MassiveNet
{
    ...
    /// <summary>
    /// Handles (de)serialization of sent and received unreliable messages.
    /// </summary>
    internal class NetChannelUnreliable
    {
        ...
        {
            if (unreliableStream.Position == 1 && !forceSend)
                return false;
        ...
        /// <summary>
        /// Writes a zero-bit to signify the lack of a reliable header.
        /// </summary>
